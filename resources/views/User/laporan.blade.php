        ...
        <div class="container">
            <div class="container-fluid">
                <a class="navbar-brand" href="{{ route('pekat.index') }}">
                    <h4 class="semi-bold mb-0 text-white">SIDUMAS</h4>
                ...
                <div class="collapse navbar-collapse" id="navbarNav">
                    ...
                    <ul class="navbar-nav text-center ml-auto">
                        ...
                        <li class="nav-item">
                            <a href="{{ route('.formRegister') }}" class="btn btn-outline-dark">Daftar</a>
                        </li>
                    </ul>
                    @endauth
                </div>
    ...
    <div class="row justify-content-between">
        <div class="col-lg-8 col-md-12 col-sm-12 col-12 col">
            <div class="content content-top shadow">
                ...
                <form action="{{ route('pekat.store') }}" method="POST" enctype="multipart/form-data">
                    ...
                    <div class="form-group">
                        <input type="text" name="lokasi" class="form-control" placeholder="Masukkan lokasi secara spesifik" >
        ...
        <div class="col-lg-4 col-md-12 col-sm-12 col-12 col">
            <div class="content content-bottom shadow">
                <div>
                    <img src="{{ asset('images/kontak.jpg') }}" alt="user profile" class="photo">
    ...
    <div class="row mt-5">
        ...
        <div class="col-lg-8">
            <div class="laporan-top">
                <img src="{{ asset('images/kontak.jpg') }}" alt="profile" class="profile">
            ...
            <div class="laporan-bottom">
                ...
                @endif
                @if ($v->tanggapan != null)
                <p class="mt-3 mb-1">{{ '*Tanggapan dari kami:'}}</p>
